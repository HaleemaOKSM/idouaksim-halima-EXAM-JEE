...
import { ContratDTO, PageResponse, StatutContrat, TypeContrat } from '../models/models';

@Injectable({ providedIn: 'root' })
export class ContratService {
  private readonly API = '/api/contrats';
  ...
  createAuto(dto: any): Observable<any> {
    return this.http.post(`${this.API}/automobile`, dto);
  }

  createHabitation(dto: any): Observable<any> {
    return this.http.post(`${this.API}/habitation`, dto);
  }

  createSante(dto: any): Observable<any> {
    return this.http.post(`${this.API}/sante`, dto);
  }
